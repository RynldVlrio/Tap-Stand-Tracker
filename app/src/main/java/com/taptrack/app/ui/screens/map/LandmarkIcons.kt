...
object LandmarkIcons {
    ...
    val FILTRATION       = LandmarkIconDef("filtration",      "Filtration Facility", Icons.Default.FilterAlt, 0xFF00897B.toInt())
    val PUMP             = LandmarkIconDef("pump",            "Motor Pump",          Icons.Default.Bolt,      0xFFE65100.toInt())
